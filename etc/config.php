<?php
	...
	$SYSTEM['version'] = '0.5.4';  // system version number
	
	$SYSTEM['debug']   =  false;   // system debugging On/Off
	
	$PATH_TO['doit'] = '../mod/';  // path to DOIT directory
	
	$MESSAGE['answer'] = 'К сожалению, я пока не знаю, что ответить на это, разработчики не научили меня :( <br><br> Введите "инфо" для отображения обучения.';
